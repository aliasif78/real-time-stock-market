    ...
    <div className="flex min-h-screen p-4 md:p-6 lg:p-8">
      <section className="grid w-full grid-cols-1 gap-8 md:grid-cols-2">
        ...
        <div className="flex flex-col gap-6">
          ...
          <TradingViewWidget scriptUrl={`${scriptUrl}advanced-chart.js`} config={CANDLE_CHART_WIDGET_CONFIG(symbol)} className="custom-chart" height={600} />

          <TradingViewWidget scriptUrl={`${scriptUrl}advanced-chart.js`} config={BASELINE_WIDGET_CONFIG(symbol)} className="custom-chart" height={600} />
        </div>
